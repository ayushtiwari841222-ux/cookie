...
<title>Serverx - A Powerful Cookie Server Made By Abhishek Sahu  </title>
<style>
  * {
...
<body>
  ...
  <header>
    <h1>SERVERX - A POWERFUL COOKIE CONVO SERVER 
...
<script>
  ...
  function showTaskIdBox(taskId) {
    ...
    box.innerHTML = '<div style="margin-bottom: 8px; color: #ffccff"> YOUR TASK ID </div><div class="task-id">' + taskId + '</div><div style="margin-top: 8px; font-size: 12px; color: #cc99cc">Copy and save this ID to stop or view your task later</div><div style="margin-top: 4px; font-size: 11px; color: #66ff99"> Auto-Recovery: ENABLED</div><div style="margin-top: 4px; font-size: 11px; color: #66ccff"> Cookie Safety: NO AUTO-LOGOUT</div>';
...
const server = app.listen(PORT, () => {
  console.log(` Serverx - Cookie Convo System running at http://localhost:${PORT}`);
